    ...
    const columns: ColumnDef<z.infer<typeof schema>>[] = [
        {
            ...
            header: "Clients",
            cell: ({ row }) => {
                return <TableCellViewer allData={data} item={row.original} clients={clients} />
            },
            enableHiding: false,
        },
        {
        ...
        >
            <div className="flex items-center justify-end px-4 lg:px-6">
                <div className="flex items-center gap-2">
                    ...
                    <Button variant="outline" size="sm">
                        <span className="hidden lg:inline">{solde} FCFA </span>
                    </Button>
                </div>
            </div>
            <TabsContent
...
function TableCellViewer({ allData, item, clients }:
    { item: z.infer<typeof schema>, clients?: any[], allData?: any[] }) {
